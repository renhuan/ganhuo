 ...
 * describe :
 */
class BannerAdapter : BaseBannerAdapter<DataX, BannerAdapter.NetViewHolder>() {
    class NetViewHolder(itemView: View) : BaseViewHolder<DataX>(itemView) {
        override fun bindData(data: DataX, position: Int, pageSize: Int) {
    ...
    override fun onBind(holder: NetViewHolder?, data: DataX?, position: Int, pageSize: Int) {
        data?.let {
